...
class MosaicCanvas
{
  public:
    ...
    void setTile(int row, int column, unsigned short k);
    ...
    unordered_map <unsigned short, TileImage*> k_tile_map;
    unordered_map <TileImage*, unsigned short> tile_k_map; 
  ...
  private:
    ...
    vector<unsigned short> myImages;
...
{
   return *(this->k_tile_map.find(myImages[row * columns + col])->second) ;
}
/**
